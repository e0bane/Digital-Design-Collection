...
initial
begin
   test_vals[0] = 28'h0_0_0_0_0_0_2;     // reset - this should always be the first vector
   test_vals[1] = 28'h0_F_0_F_5_0_2;     // get 3 into the accumulator
   test_vals[2] = 28'h0_C_0_C_A_0_2;     // add 3+5 and store in the accumulator
   test_vals[3] = 28'h0_3_0_3_F_0_2;     // do nothing the rest of the way
   test_vals[4] = 28'h0_0_0_0_0_0_1;
   test_vals[5] = 28'h0_F_0_0_5_0_1;
   test_vals[6] = 28'h0_C_0_0_A_0_1;
   test_vals[7] = 28'h0_3_0_0_F_0_1;
end
