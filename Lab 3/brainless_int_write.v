...
initial
begin
   test_vals[0] = 28'h2_2_4_2_0_5_0;     // reset - this should always be the first vector
   test_vals[1] = 28'h2_2_2_0_0_0_A;     // get 3 into the accumulator
   test_vals[2] = 28'h4_2_6_2_C_5_0;     // add 3+5 and store in the accumulator
   test_vals[3] = 28'h4_4_4_0_C_0_A;     // do nothing the rest of the way
   test_vals[4] = 28'h0_0_0_0_0_0_4;
   test_vals[5] = 28'h0_2_0_0_0_0_1;
   test_vals[6] = 28'h0_4_0_0_C_0_1;
end
